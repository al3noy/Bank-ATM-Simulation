...
public class FXMLPodigniController implements Initializable {
    ...
    @FXML
    private void isplatiNovac(ActionEvent event) {
         isplata = Integer.parseInt(txfIsplata.getText());
         ...
         if(trenutnoStanje==0 || trenutnoStanje<0){
             btnIsplata.setDisable(true);
             ...
             a3.setContentText("Nemate vise sredstava na banci!");
             a3.showAndWait();
